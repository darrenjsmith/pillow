Template.tipPage.rendered = function() {
   ...
   setTimeout(function() {
     ...
     (function(d, s, id) {
       ...
       js.src = "//connect.facebook.net/en_GB/sdk.js#xfbml=1&appId=1508235372795638&version=v2.0";
...
function share(tip) {
   ...
   setTimeout(function() { 
     ...
     $('#share').append('<fb:send href="' + urlToShare + '" colorscheme="light"></fb:send><div class="fb-like" data-href="' + urlToShare + '" data-layout="button" data-action="like" data-show-faces="false" data-share="false"></div><a href="https://twitter.com/share" class="twitter-share-button" data-url="' + urlToShare + '" data-text="' + tip.content + '" data-via="trypillow">Tweet</a>');
